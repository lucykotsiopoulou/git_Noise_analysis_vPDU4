...
#----------For Four tiles
plot "FFT-run912-chan1.txt" u 1:2 w l t "Tile 1 and 2 and 3 and 4 (full Q2)" lc "light-pink" #Tile 1and2and3and4
...
#----------Graphic art---------------
set title "COLD Noise for vPDU4 | Quadrant 2 tiles"
