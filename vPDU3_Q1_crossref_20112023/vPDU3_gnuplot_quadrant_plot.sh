...
#----------For Four tiles
#plot "FFT-run767-chan0.txt" u 1:2 w l t "Tile 1 and 2 and 3 and 4 (full Q1)" lc "light-pink" #Tile 1and2and3and4
...
plot "FFT-run842-chan0.txt" u 1:2 w l t "Tile 1 and 3 and 4" lc "yellow4" #Tile 1and3and4
replot "FFT-run844-chan0.txt" u 1:2 w l t "Tile 2 and 3 and 4" lc "sea-green" #Tile 2and3and4
replot "FFT-run843-chan0.txt" u 1:2 w l t "Tile 1 and 2 and 4" lc "spring-green" #Tile 1and2and4
