...
#plot "FFT-run915-chan0.txt" u 1:2 w l t "Tile 2" lc "royalblue" #Tile 2
#plot "FFT-run916-chan0.txt" u 1:2 w l t "Tile 3" lc "dark-blue" #Tile 3
#plot "FFT-run917-chan0.txt" u 1:2 w l t "Tile 4" lc "skyblue" #Tile 4

#----------For two tiles
#plot "FFT-run918-chan0.txt" u 1:2 w l t "Tile 1 and 2" lc "purple" #Tile 1and2
...
plot "FFT-run911-chan0.txt" u 1:2 w l t "Tile 1 and 2 and 3 and 4 (full Q1)" lc "light-pink" #Tile 1and2and3and4
replot "FFT-run915-chan0.txt" u 1:2 w l t "Tile 2" lc "royalblue" #Tile 2
...
#------Plain tile plots
#set output "./simple_plots/noise_tile1and2.png"
...
set output "./overlays/noise_overlay_tile1and2and3and4_tile2.png"
